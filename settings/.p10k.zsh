# Generated by Powerlevel10k configuration wizard on 2020-04-08 at 22:34 NZST.
...
# 2 lines, solid, no frame, dark-ornaments, compact, many icons, concise,
...
newline
    ...
    # =========================[ Line #2 ]=========================
    newline
    time                    # ip address and bandwidth usage for a specified network interface
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=34
  # Make the icon bold.
...
typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=$'\uf63d'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION=0.0
